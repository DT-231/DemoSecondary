        ...
        <li>
            <div className="flex-start flex items-center pt-10 relative">
                ...
                <div className="relative bottom-4">
                    <p className="text-6xl  font-primary text-primary dark:text-primary relative z-10">
                        {workFlow.order_number}
                    </p>
                    <div
                        className="absolute top-1/2 left-1/2 transform -translate-x-1/3 -translate-y-1/4 
                        w-full h-full bg-primary/30 blur-[10px] rounded-lg animate-pulse z-0"
                    ></div>
                </div>
                <h4 className="md:mb-1.5 -mt-4 ml-10 md:text-4xl  text-3xl uppercase text-primary font-semibold">
                    {workFlow.title}
                </h4>
            </div>
            <div className="mb-10 ml-4 mt-2">
                <p className="mb-3 lg:w-xs w-3xs ml-20 text-xl text-primary font-secondary">{workFlow.content}</p>
            </div>
        </li>
    );
};
